<?php 
 $GLOBALS["dictionary"]["Call"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'CustomerID',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'customerid_c',
      'vname' => 'LBL_CUSTOMERID',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Callscustomerid_c',
      'custom_module' => 'Calls',
    ),
    'setuptime_c' => 
    array (
      'inline_edit' => '',
      'labelValue' => 'setupTime',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'setuptime_c',
      'vname' => 'LBL_SETUPTIME',
      ...
      'default' => '',
      'no_default' => false,
      'comments' => 'Call setup time in Ms',
      'help' => '',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
    ...
    array (
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'scrm_calls_campaignid_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Callscampaignid_c',
      'custom_module' => 'Calls',
    ),
    'dispositioncode_c' => 
    array (
      'inline_edit' => '',
      'labelValue' => 'Disposition Code',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'dispositioncode_c',
      'vname' => 'LBL_DISPOSITIONCODE',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'scrm_calls_dispositioncode_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Callsdispositioncode_c',
      'custom_module' => 'Calls',
    ),
    'ivrtime_c' => 
    array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'crtobjectid',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'crtobjectid_c',
      'vname' => 'LBL_CRTOBJECTID',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      ...
      'enable_range_search' => false,
      'display_default' => 'now',
      'id' => 'Callsstart_date_c',
      'custom_module' => 'Calls',
    ),
    'dispositionclass_c' => 
    array (
      'inline_edit' => '',
      'labelValue' => 'Disposition Class',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'dispositionclass_c',
      'vname' => 'LBL_DISPOSITIONCLASS',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Callsdispositionclass_c',
      'custom_module' => 'Calls',
    ),
    'ringingtime_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Ringing Time (in ms)',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'ringingtime_c',
      'vname' => 'LBL_RINGINGTIME',
      'type' => 'int',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'min' => false,
      'max' => false,
      'id' => 'Callsringingtime_c',
      'custom_module' => 'Calls',
    ),
    'recordingfileurl_c' => 
    array (
      'inline_edit' => '',
      'labelValue' => 'recordingFileUrl',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'recordingfileurl_c',
      'vname' => 'LBL_RECORDINGFILEURL',
      'type' => 'url',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'scrm_calls_calltype_list2',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Callscalltype_c',
      'custom_module' => 'Calls',
    ...
    array (
      'inline_edit' => '',
      'labelValue' => 'systemDisposition',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'systemdisposition_c',
      'vname' => 'LBL_SYSTEMDISPOSITION',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Non office menu',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'non_office_menu_c',
      'vname' => 'LBL_NON_OFFICE_MENU',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'non_office_menu_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Callsnon_office_menu_c',
      'custom_module' => 'Calls',
    ),
    'language_c' => 
    array (
    ...
    array (
      ...
      'vname' => 'LBL_SCRM_PRODUCTS_ACTIVITIES_1_CALLS_FROM_SCRM_PRODUCTS_TITLE',
    ),
    'product_interest_c' => 
    array (
      'inline_edit' => '1',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Callsproduct_interest_c',
      'custom_module' => 'Calls',
    ),
    'linkclicked_date_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'LinkClicked Date',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'linkclicked_date_c',
      'vname' => 'LBL_LINKCLICKED_DATE',
      'type' => 'date',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'size' => '20',
      'enable_range_search' => false,
      'id' => 'Callslinkclicked_date_c',
      'custom_module' => 'Calls',
    ),
    'registration_date_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Registration Date',
      'required' => false,
      'source' => 'custom_fields',
