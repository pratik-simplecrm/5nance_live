...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_LINK_NAME' => 'Dashboard Manager',
  'LBL_LINK_DESCRIPTION' => 'Copy Dashboard',
  'LBL_SECTION_HEADER' => 'Copy 1 user dashboard to multiple users.',
  'LBL_SECTION_DESCRIPTION' => 'Copy dashboard manager',
  ...
  'LBL_PRODUCT_ASSIGNMENT_LINK_NAME' => 'Assign Products',
  'LBL_PRODUCT_ASSIGNMENT_LINK_DESCRIPTION' => 'Here you can assign a respective products to the users.',
  'LBL_PRODUCT_ASSIGNMENT_SECTION_HEADER' => 'Product wise Assignment',
  'LBL_PRODUCT_ASSIGNMENT_SECTION_DESCRIPTION' => 'Admin can assign a respective product (Under User Profile).',
);