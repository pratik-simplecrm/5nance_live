<?php /* Smarty version 2.6.11, created on 2016-10-26 18:10:39
         compiled from include/ListView/ListViewGeneric.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'include/ListView/ListViewGeneric.tpl', 83, false),array('modifier', 'default', 'include/ListView/ListViewGeneric.tpl', 135, false),array('modifier', 'lower', 'include/ListView/ListViewGeneric.tpl', 138, false),array('modifier', 'upper', 'include/ListView/ListViewGeneric.tpl', 141, false),array('modifier', 'in_array', 'include/ListView/ListViewGeneric.tpl', 235, false),array('function', 'counter', 'include/ListView/ListViewGeneric.tpl', 128, false),array('function', 'sugar_translate', 'include/ListView/ListViewGeneric.tpl', 146, false),array('function', 'sugar_getimage', 'include/ListView/ListViewGeneric.tpl', 152, false),array('function', 'sugar_ajax_url', 'include/ListView/ListViewGeneric.tpl', 265, false),array('function', 'sugar_evalcolumn_old', 'include/ListView/ListViewGeneric.tpl', 269, false),array('function', 'sugar_field', 'include/ListView/ListViewGeneric.tpl', 271, false),)), $this); ?>
...
">
			...
			<div class="dropdown">
			 ...
			 <ul class="dropdown-menu animated fadeIn">
        		<li><a id="edit-<?php echo $this->_tpl_vars['rowData']['ID']; ?>
...
"><i class="fa fa-edit"></i>Edit</a></li>
        		...
        		<!-- <input type="checkbox" value="1ac527da-76c7-08e6-ee1b-5526574a0937" name="mass[]" class="checkbox" onclick="sListView.check_item(this, document.MassUpdate)" title="Select this row"> -->

        		

         		<li><a id="delete_listview_top" onclick="document.getElementById('<?php echo $this->_tpl_vars['rowData']['ID']; ?>
').checked = true;var r = sListView.send_mass_update('selected','Please select at least 1 record to proceed.', 1); r?'':document.getElementById('<?php echo $this->_tpl_vars['rowData']['ID']; ?>
').checked = false"><i class="fa fa-trash"></i>Delete</a></li>
...
'> -->
         		...
         		<?php 
  					$this->assign("module", array('ACLRoles','SF_Sales_Forecast','ProspectLists','Cases'));
				 ?>

         		<?php if (! ((is_array($_tmp=$this->_tpl_vars['linkModule'])) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['module']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['module']))): ?>

         		

         		<li><a href="?module=Calls&action=EditView&return_module=<?php echo $this->_tpl_vars['linkModule']; ?>
&return_action=ListView&parent_name=test&parent_id=<?php echo $this->_tpl_vars['rowData']['ID']; ?>
&parent_type=<?php echo $this->_tpl_vars['linkModule']; ?>
"><i class="fa fa-phone"></i>Log Call</a></li>

         		<li><a href="?module=Meetings&action=EditView&return_module=<?php echo $this->_tpl_vars['linkModule']; ?>
&return_action=ListView&parent_name=test&parent_id=<?php echo $this->_tpl_vars['rowData']['ID']; ?>
&parent_type=<?php echo $this->_tpl_vars['linkModule']; ?>
"><i class="fa fa-users"></i>Schedule Meeting</a></li>
         		<li><a href="?module=Tasks&action=EditView&return_module=<?php echo $this->_tpl_vars['linkModule']; ?>
&return_action=ListView&parent_name=test&parent_id=<?php echo $this->_tpl_vars['rowData']['ID']; ?>
&parent_type=<?php echo $this->_tpl_vars['linkModule']; ?>
"><i class="fa fa-tasks"></i>Add To Do</a></li>
         		<?php endif; ?>
    		</ul>
    		</div>
  ...
  <!-- 	<a href="javascript:void(0)" id="delete_listview_top" onclick="return sListView.send_mass_update('selected', 'Please select at least 1 record to proceed.', 1)">Delete<div></div></a> -->
...
?>
				...
				<?php endforeach; endif; unset($_from); ?>
				<td align='right'><a title="Preview" style="cursor:pointer">
