...
//~ echo "ok";exit;
  ...
  if(!defined('sugarEntry') || !sugarEntry) die('Not A Valid Entry Point');
	...
	$GLOBALS['log']->fatal("The Customentry point parameter from  Ameyo corporate: " . print_r($_REQUEST, true));
   ...
   // Rest API to create the call record
    ...
    $set_entry_parameters = array(
         ...
         "name_value_list" => array(
              ...
              array("name" => "name", "value" => "New corporate call"),
