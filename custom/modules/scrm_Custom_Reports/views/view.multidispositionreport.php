...
//
        if (isset($_POST['Export'])) {
            ...
            foreach ($rows_list as $row) {
                ...
                $data .= '<td>' . str_replace("_"," ",$row['drop_stage']) . '</td>';
                $data .= '<td>' . $row['rejection_reason'] . '</td>';
                $data .= '<td>' . $row['city_name'] . '</td>';
                $data .= '<td>' . $row['age_user'] . '</td>';
                $data .= '<td>' . $row['annual_income'] . '</td>';
                $data .= '<td>' . $row['occupational_details'] . '</td>';
                $data .= '<td>' . $row['marital_status'] . '</td>';

                $data .= '<td>' . $row['qparam_c'] . '</td>';
                $data .= '<td>' . $row['date_entered'] . '</td>';
                $data .= '<td>' . $row['user_allocation_date_c'] . '</td>';
                $data .= '<td>' . $row['assignment_tat'] . '</td>';
                $data .= '<td>' . str_replace("_"," ",$row['sales_stage_c']) . '</td>';
...
$(document).ready(function() {
        ...
        {bSortable: false,aTargets: [ -31 ]},       
        {bSortable: false,aTargets: [ -32 ]},  

        {bSortable: false,aTargets: [ -33 ]},  
        {bSortable: false,aTargets: [ -34 ]},       
        {bSortable: false,aTargets: [ -35 ]}, 
        {bSortable: false,aTargets: [ -36 ]},       
...
<div class="dt-example">
  ...
  <th data-toggle="true" scope="col">
            ...
            <th data-toggle="true" scope="col">
                <div align="left" width="100%" style="white-space: normal;">Drop Stage</div>
            </th>
            <th data-toggle="true" scope="col">
                <div align="left" width="100%" style="white-space: normal;">Rejection Reason</div>
            </th>
            <th data-toggle="true" scope="col">
                <div align="left" width="100%" style="white-space: normal;">City</div>
            </th>
            <th data-toggle="true" scope="col">
                <div align="left" width="100%" style="white-space: normal;">Age</div>
            </th>
            <th data-toggle="true" scope="col">
                <div align="left" width="100%" style="white-space: normal;">Income</div>
            </th>
            <th data-toggle="true" scope="col">
                <div align="left" width="100%" style="white-space: normal;">Occupation</div>
            </th>
            <th data-toggle="true" scope="col">
                <div align="left" width="100%" style="white-space: normal;">Intent</div>
            </th>
            <th data-toggle="true" scope="col">
                <div align="left" width="100%" style="white-space: normal;">Marital Status</div>
            </th>
...
//            print_r($rows_list);
            ...
            fputcsv($output, array('Lead ID', 'First Name', 'Last Name', 'Email Address', 'Mobile Number', 'Gateway (Source)', 'Campaign Type', 'Sales Advisor', 'Product Interest', 'Product Sub Interest', 'UTM Content', 'Source Campaign', 'Source','Drop Stage','Rejection Reason','City','Age','Annual Income','Occupational Details', 'Marital Status','Publisher Sub ID', 'User Creation Date', 'Advisor Assignment Date/Time', 'Assignment TAT', 'Sales Stage', 'Comments', 'Latest Disposition', 'First Call TAT','Last Modified','Disposition 1', 'Date & Time', 'Disposition 2', 'Date & Time', 'Disposition 3', 'Date & Time', 'Disposition 4', 'Date & Time', 'Disposition 5', 'Date & Time', 'Disposition 6', 'Date & Time', 'Disposition 7', 'Date & Time', 'Disposition 8', 'Date & Time', 'Disposition 9', 'Date & Time', 'Disposition 10', 'Date & Time', 'End to End TAT'));
...
//        print_r($disposition_list);
       // print_r($contact_row);
        while ($contact_row = $db->fetchByAssoc($contact_result)) {
            ...
            $data[$r]['drop_stage'] = str_replace("_"," ",$contact_row['drop_stage']);
            $data[$r]['rejection_reason'] = $contact_row['rejection_reason'];
            $data[$r]['city_name'] = $contact_row['city_name'];
            ...
            $data[$r]['annual_income'] = $contact_row['annual_income'];
            $data[$r]['occupational_details'] = $contact_row['occupational_details'];
            $data[$r]['occupational_details'] = $contact_row['intent_c'];
            $data[$r]['marital_status'] = $contact_row['marital_status'];
        ...
        $assignment_tat = $hours . ":" . $minutes . ":" . $second;
            ...
            $data[$r]['sales_stage_c'] = str_replace("_"," ",$contact_row['sales_stage_c']);
