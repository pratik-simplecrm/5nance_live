...
$subpanel_layout = array(
    ...
    'where' => "(calls.status != 'Held' AND calls.status != 'Not Held' AND calls.status!='Missed')",
    'list_fields' => array(
        'object_image' => array(
        ...
        'product_interest_c' => array(
            ...
            'width' => '15%',
            'force_default' => "(SELECT product_interest_c  FROM calls_cstm where calls_cstm.id_c=calls.id) AS ",
        ),
        'status' => array(
