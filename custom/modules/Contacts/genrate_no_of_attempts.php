...
class GenrateContactsNoOfAttempts {

    public function GenrateContactsNoOfAttemptsMethod(&$bean, $event, $args) {
        ...
        if (!empty($array_call)) {
            ...
            $update_query = "UPDATE contacts_cstm SET no_of_attempts_c ='" . $no_of_attempts . "'  WHERE id_c = '" . $bean->id . "'";
