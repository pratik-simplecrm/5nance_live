    ...
    */
        ...
        )
    {
	  ...
	  if(!empty($GLOBALS['app_list_strings']['parent_type_display'][$module])){$module_name=$GLOBALS['app_list_strings']['parent_type_display'][$module];}else{$module_name=$GLOBALS['app_list_strings']['moduleList'][$module];}
			//$theTitle .= "<span class='text-uppercase'>".$module_name."</span><br><span style='font-size:16px'> $paramString </span><br><br>";
			$theTitle .= "<span style='font-size:16px'> $paramString </span><br><br>";
   }  
/*
...
<a id="create_link" href="{$url}" class="btn btn-outline-primary">
<span class="fa fa-plus"></span>{$GLOBALS['app_strings']['LNK_CREATE']}
</a>&nbsp;
<!--<a id="" class='btn btn-outline-primary' href="index.php?module=Import&action=Step1&import_module=$module&return_module=$module&return_action=index"> <span class="fa fa-download"></span>{$GLOBALS['app_strings']['LBL_IMPORT']}</a>&nbsp;-->
EOHTML;
            }
            $theTitle .= "</span>";
