<?php 
 $GLOBALS["dictionary"]["Employee"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Download Link',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'download_link_c',
      'vname' => 'LBL_DOWNLOAD_LINK',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => 'Internal Demo Environment. Not for external use.',
      'no_default' => false,
      'comments' => '',
      'help' => '',
      'importable' => 'true',
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Gateway Assigned',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'gateway_assigned_c',
      'vname' => 'LBL_GATEWAY_ASSIGNED',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
    ...
    array (
      ...
      'bean_name' => 'scrm_User_Assignment_Rule',
      'side' => 'right',
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Login Flag',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'login_flag_c',
      'vname' => 'LBL_LOGIN_FLAG',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'ameyo campaign id',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'ameyo_campaign_id_c',
      'vname' => 'LBL_AMEYO_CAMPAIGN_ID',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Usersameyo_campaign_id_c',
      'custom_module' => 'Users',
    ),
    'ameyosessionid_c' => 
    array (
      'inline_edit' => '',
      'labelValue' => 'ameyosessionid',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'ameyosessionid_c',
      'vname' => 'LBL_AMEYOSESSIONID',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Usersameyosessionid_c',
      'custom_module' => 'Users',
    ),
    'availability_status_c' => 
    array (
      'inline_edit' => '',
      'labelValue' => 'Availability Status',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'availability_status_c',
      'vname' => 'LBL_AVAILABILITY_STATUS_C',
      'type' => 'enum',
      'massupdate' => '1',
      'default' => 'Available',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'availability_status_c_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Usersavailability_status_c',
      'custom_module' => 'Users',
    ),
  ),
  'indices' => 
