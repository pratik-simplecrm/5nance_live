<?php 
 $GLOBALS["dictionary"]["scrm_Login_Audit"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_login_audit_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_login_audit_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'scrm_login_audit_assigned_user',
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Logged In User',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'users_sugar_id_c',
      'vname' => 'LBL_USERS_SUGAR_ID',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'scrm_Login_Auditusers_sugar_id_c',
      'custom_module' => 'scrm_Login_Audit',
    ),
    'ip_address_c' => 
    array (
      'inline_edit' => '1',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'scrm_Login_Auditip_address_c',
      'custom_module' => 'scrm_Login_Audit',
    ),
    'total_logged_in_time_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Total Logged In Time',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'total_logged_in_time_c',
      'vname' => 'LBL_TOTAL_LOGGED_IN_TIME',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'scrm_Login_Audittotal_logged_in_time_c',
      'custom_module' => 'scrm_Login_Audit',
    ),
    'logins_per_day_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Total Logins Per Day',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'logins_per_day_c',
      'vname' => 'LBL_LOGINS_PER_DAY',
      'type' => 'int',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'min' => false,
      'max' => false,
      'id' => 'scrm_Login_Auditlogins_per_day_c',
      'custom_module' => 'scrm_Login_Audit',
    ),
    ...
    'users_scrm_login_audit_2users_ida' => 
    array (
