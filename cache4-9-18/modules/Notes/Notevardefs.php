<?php 
 $GLOBALS["dictionary"]["Note"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'comment reply id',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'comment_reply_id_c',
      'vname' => 'LBL_COMMENT_REPLY_ID',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'post data in fb',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'post_data_in_fb_c',
      'vname' => 'LBL_POST_DATA_IN_FB',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => 'post',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Notespost_data_in_fb_c',
      'custom_module' => 'Notes',
    ),
    'comment_id_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'comment id',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'comment_id_c',
    ...
    array (
      ...
      'bean_name' => 'scrm_Products',
      'vname' => 'LBL_SCRM_PRODUCTS_ACTIVITIES_1_NOTES_FROM_SCRM_PRODUCTS_TITLE',
    ),
    'product_interest_c' => 
    array (
      'inline_edit' => '1',
