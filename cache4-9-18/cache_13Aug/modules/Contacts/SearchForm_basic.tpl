...
<input type='text' name='{$fields.search_name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='phone_mobile_basic' >{sugar_translate label='LBL_MOBILE_PHONE' module='Contacts'}</label>
    	</td>
