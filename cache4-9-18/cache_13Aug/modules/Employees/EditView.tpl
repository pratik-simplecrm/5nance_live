...
<ul class="yui-nav">
<li class="selected"><a id="tab0" href="javascript:void(0)"><em>{sugar_translate label='DEFAULT' module='Employees'}</em></a></li>
</ul>
...
addToValidate('EditView', 'asterisk_inbound_c', 'bool', false,'{/literal}{sugar_translate label='LBL_ASTERISK_INBOUND' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'agent_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AGENT_NAME' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'agent_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AGENT_ID' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'download_link_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_DOWNLOAD_LINK' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'download_source_code_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_DOWNLOAD_SOURCE_CODE' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'asterisk_outbound_c', 'bool', false,'{/literal}{sugar_translate label='LBL_ASTERISK_OUTBOUND' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'gateway_assigned_c', 'bool', false,'{/literal}{sugar_translate label='LBL_GATEWAY_ASSIGNED' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'agent_pin_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AGENT_PIN' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'asterisk_ext_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ASTERISK_EXT' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'login_flag_c', 'bool', false,'{/literal}{sugar_translate label='LBL_LOGIN_FLAG' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'ameyo_campaign_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AMEYO_CAMPAIGN_ID' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'ameyosessionid_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AMEYOSESSIONID' module='Employees' for_js=true}{literal}' );
addToValidate('EditView', 'availability_status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_AVAILABILITY_STATUS_C' module='Employees' for_js=true}{literal}' );
