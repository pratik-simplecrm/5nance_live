...
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='scrm_Products'}{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PRODUCT_INTEREST' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PRODUCT_SUB_TYPE_INTEREST' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PAYMENT_TYPE' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_SOURCE' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_PARTNER_NAME' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.partner_name_c.value) <= 0}
{assign var="value" value=$fields.partner_name_c.default_value }
{else}
{assign var="value" value=$fields.partner_name_c.value }
{/if}  
<input type='text' name='{$fields.partner_name_c.name}' 
id='{$fields.partner_name_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='partner_comments_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_PARTNER_COMMENTS_C' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CAMPAIGN_TYPE' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_UTM_CAMPAIGN_ID' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.utm_campaign_id_c.value) <= 0}
{assign var="value" value=$fields.utm_campaign_id_c.default_value }
{else}
{assign var="value" value=$fields.utm_campaign_id_c.value }
{/if}  
<input type='text' name='{$fields.utm_campaign_id_c.name}' 
id='{$fields.utm_campaign_id_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_OPPORTUNITY_VALUE' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_OPPORTUNITY_HORIZON' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_INVESTMENT_BEHAVIOUR_SEGMENT' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_NO_OF_ATTEMPTS' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_SALES_STAGE' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_DISPOSITION' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_NEXT_CALL_PLANNING_DATE' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_NEXT_CALL_PLANNING_COMMENTS' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_COMMENT' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
{if empty($fields.comment_c.value)}
{assign var="value" value=$fields.comment_c.default_value }
{else}
{assign var="value" value=$fields.comment_c.value }
{/if}  
<textarea  id='{$fields.comment_c.name}' name='{$fields.comment_c.name}'
rows="4" 
cols="20" 
title='' tabindex="0" 
 >{$value}</textarea>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CONTACTS_SCRM_PRODUCTS_1_FROM_CONTACTS_TITLE' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<input type="text" name="{$fields.contacts_scrm_products_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.contacts_scrm_products_1_name.name}" size="" value="{$fields.contacts_scrm_products_1_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.contacts_scrm_products_1_name.id_name}" 
id="{$fields.contacts_scrm_products_1_name.id_name}" 
value="{$fields.contacts_scrm_products_1contacts_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.contacts_scrm_products_1_name.name}" id="btn_{$fields.contacts_scrm_products_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_CONTACTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_CONTACTS_LABEL"}"
onclick='open_popup(
"{$fields.contacts_scrm_products_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"contacts_scrm_products_1contacts_ida","name":"contacts_scrm_products_1_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.contacts_scrm_products_1_name.name}" id="btn_clr_{$fields.contacts_scrm_products_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_CONTACTS_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.contacts_scrm_products_1_name.name}', '{$fields.contacts_scrm_products_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_CONTACTS_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.contacts_scrm_products_1_name.name}']) != 'undefined'",
		enableQS
);
</script>
</tr>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='scrm_Products'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'no_of_attempts_c', 'int', false,'{/literal}{sugar_translate label='LBL_NO_OF_ATTEMPTS' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'payment_type_c', 'dynamicenum', false,'{/literal}{sugar_translate label='LBL_PAYMENT_TYPE' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'opportunity_horizon_c', 'date', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITY_HORIZON' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'next_call_planning_date_c_date', 'date', false,'Next Call Planning Date' );
addToValidate('EditView', 'next_call_planning_comments_c', 'text', false,'{/literal}{sugar_translate label='LBL_NEXT_CALL_PLANNING_COMMENTS' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'source_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SOURCE' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'product_interest_c', 'enum', false,'{/literal}{sugar_translate label='LBL_PRODUCT_INTEREST' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'investment_behaviour_segment_c', 'enum', false,'{/literal}{sugar_translate label='LBL_INVESTMENT_BEHAVIOUR_SEGMENT' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'currency_id', 'currency_id', false,'{/literal}{sugar_translate label='LBL_CURRENCY' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'opportunity_value_c', 'currency', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITY_VALUE' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'campaign_type_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CAMPAIGN_TYPE' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'product_sub_type_interest_c', 'enum', false,'{/literal}{sugar_translate label='LBL_PRODUCT_SUB_TYPE_INTEREST' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'sales_stage_c', 'enum', false,'{/literal}{sugar_translate label='LBL_SALES_STAGE' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'comment_c', 'text', true,'{/literal}{sugar_translate label='LBL_COMMENT' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'utm_campaign_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_UTM_CAMPAIGN_ID' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'disposition_c', 'enum', true,'{/literal}{sugar_translate label='LBL_DISPOSITION' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'contacts_scrm_products_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CONTACTS_SCRM_PRODUCTS_1_FROM_CONTACTS_TITLE' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'partner_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PARTNER_NAME' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'partner_comments_c', 'text', false,'{/literal}{sugar_translate label='LBL_PARTNER_COMMENTS_C' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'assistant_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ASSISTANT_ID' module='scrm_Products' for_js=true}{literal}' );
addToValidate('EditView', 'user_allocation_date_c_date', 'date', false,'User Allocation Date' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='scrm_Products' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='scrm_Products' for_js=true}{literal}', 'assigned_user_id' );
addToValidateBinaryDependency('EditView', 'contacts_scrm_products_1_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='scrm_Products' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_CONTACTS_SCRM_PRODUCTS_1_FROM_CONTACTS_TITLE' module='scrm_Products' for_js=true}{literal}', 'contacts_scrm_products_1contacts_ida' );
