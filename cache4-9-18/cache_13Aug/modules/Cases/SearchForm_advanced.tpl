...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='source_c_advanced'>{sugar_translate label='LBL_SOURCE' module='Cases'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='source_c_advanced' name='source_c_advanced[]' options=$fields.source_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.source_c_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='module_c_advanced'>{sugar_translate label='LBL_MODULE' module='Cases'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='module_c_advanced' name='module_c_advanced[]' options=$fields.module_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.module_c_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='contacts_cases_1_name_advanced'>{sugar_translate label='LBL_CONTACTS_CASES_1_FROM_CONTACTS_TITLE' module='Cases'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<input type="text" name="{$fields.contacts_cases_1_name_advanced.name}"  class="sqsEnabled"   id="{$fields.contacts_cases_1_name_advanced.name}" size="" value="{$fields.contacts_cases_1_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.contacts_cases_1contacts_ida_advanced.name}" value="{$fields.contacts_cases_1contacts_ida_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.contacts_cases_1_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.contacts_cases_1_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"contacts_cases_1contacts_ida_advanced","name":"contacts_cases_1_name_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.contacts_cases_1_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.contacts_cases_1_name_advanced.name}.value = ''; this.form.{$fields.contacts_cases_1contacts_ida_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='email1_advanced'>{sugar_translate label='LBL_EMAIL' module='Cases'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.email1_advanced.value) <= 0}
{assign var="value" value=$fields.email1_advanced.default_value }
{else}
{assign var="value" value=$fields.email1_advanced.value }
{/if}  
<input type='text' name='{$fields.email1_advanced.name}' 
    id='{$fields.email1_advanced.name}' size='30' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='mobile_number_c_advanced'>{sugar_translate label='LBL_MOBILE_NUMBER' module='Cases'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.mobile_number_c_advanced.value) <= 0}
{assign var="value" value=$fields.mobile_number_c_advanced.default_value }
{else}
{assign var="value" value=$fields.mobile_number_c_advanced.value }
{/if}  
<input type='text' name='{$fields.mobile_number_c_advanced.name}' 
    id='{$fields.mobile_number_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
   	   	</td>
...
{html_options id='state_advanced' name='state_advanced[]' options=$fields.state_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.state_advanced.value}
   	   	</td>
...
{html_options id='priority_advanced' name='priority_advanced[]' options=$fields.priority_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.priority_advanced.value}
   	   	</td>
...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.assigned_user_id_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='Cases'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
