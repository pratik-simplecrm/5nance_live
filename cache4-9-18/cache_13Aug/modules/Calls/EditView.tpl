...
maxlength='45' 
value='{$value}' title='trimmed callerId'      >
</tr>
{/capture}
{if $fieldsUsed > 0 }
{$tableRow}
...
addToValidate('EditView', 'asterisk_caller_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ASTERISK_CALLER_ID' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'customerid_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CUSTOMERID' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'setuptime_c', 'int', false,'{/literal}{sugar_translate label='LBL_SETUPTIME' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'campaignid_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CAMPAIGNID' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'dispositioncode_c', 'enum', false,'{/literal}{sugar_translate label='LBL_DISPOSITIONCODE' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'ivrtime_c', 'int', false,'{/literal}{sugar_translate label='LBL_IVRTIME' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'dstphone_c', 'phone', false,'{/literal}{sugar_translate label='LBL_DSTPHONE' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'crtobjectid_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CRTOBJECTID' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'start_date_c', 'date', false,'{/literal}{sugar_translate label='LBL_START_DATE' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'dispositionclass_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_DISPOSITIONCLASS' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'ringingtime_c', 'int', false,'{/literal}{sugar_translate label='LBL_RINGINGTIME' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'recordingfileurl_c', 'url', false,'{/literal}{sugar_translate label='LBL_RECORDINGFILEURL' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'srcphone_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SRCPHONE' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'calltype_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CALLTYPE' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'callid_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CALLID' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'systemdisposition_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SYSTEMDISPOSITION' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'phone_c', 'phone', false,'{/literal}{sugar_translate label='LBL_PHONE' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'talktime_c', 'int', false,'{/literal}{sugar_translate label='LBL_TALKTIME' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'non_office_menu_c', 'enum', false,'{/literal}{sugar_translate label='LBL_NON_OFFICE_MENU' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'language_c', 'enum', false,'{/literal}{sugar_translate label='LBL_LANGUAGE' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'product_interest_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PRODUCT_INTEREST' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'linkclicked_date_c', 'date', false,'{/literal}{sugar_translate label='LBL_LINKCLICKED_DATE' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'registration_date_c', 'date', false,'{/literal}{sugar_translate label='LBL_REGISTRATION_DATE' module='Calls' for_js=true}{literal}' );
