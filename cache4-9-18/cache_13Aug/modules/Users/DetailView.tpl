...
{sugar_translate label='LBL_DETAILVIEW_PANEL2' module='Users'}
<script>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.asterisk_ext_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.asterisk_ext_c.name}">{$fields.asterisk_ext_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.asterisk_inbound_c.hidden}
...
{/if}
<input type="checkbox" class="checkbox" name="{$fields.asterisk_inbound_c.name}" id="{$fields.asterisk_inbound_c.name}" value="$fields.asterisk_inbound_c.value" disabled="true" {$checked}>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>
</td>
</tr>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.asterisk_outbound_c.hidden}
...
{assign var="checked" value=""}
{/if}
<input type="checkbox" class="checkbox" name="{$fields.asterisk_outbound_c.name}" id="{$fields.asterisk_outbound_c.name}" value="$fields.asterisk_outbound_c.value" disabled="true" {$checked}>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.agent_id_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.agent_id_c.name}">{$fields.agent_id_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>
</td>
</tr>
...
{/if} 
<span class="sugar_field" id="{$fields.agent_name_c.name}">{$fields.agent_name_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.agent_pin_c.hidden}
...
{/if} 
<span class="sugar_field" id="{$fields.agent_pin_c.name}">{$fields.agent_pin_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>
</td>
</tr>
