...
{capture name="label" assign="label"}{sugar_translate label='LBL_GATEWAY_ASSIGNED' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strval($fields.gateway_assigned_c.value) == "1" || strval($fields.gateway_assigned_c.value) == "yes" || strval($fields.gateway_assigned_c.value) == "on"} 
{assign var="checked" value="CHECKED"}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.gateway_assigned_c.name}" value="0"> 
<input type="checkbox" id="{$fields.gateway_assigned_c.name}" 
name="{$fields.gateway_assigned_c.name}" 
...
{capture name="label" assign="label"}{sugar_translate label='LBL_AVAILABILITY_STATUS_C' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.availability_status_c.name}" 
id="{$fields.availability_status_c.name}" 
title=''       
>
{if isset($fields.availability_status_c.value) && $fields.availability_status_c.value != ''}
{html_options options=$fields.availability_status_c.options selected=$fields.availability_status_c.value}
{else}
{html_options options=$fields.availability_status_c.options selected=$fields.availability_status_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.availability_status_c.options }
{capture name="field_val"}{$fields.availability_status_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.availability_status_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.availability_status_c.name}" 
id="{$fields.availability_status_c.name}" 
title=''          
>
{if isset($fields.availability_status_c.value) && $fields.availability_status_c.value != ''}
...
<input
id="{$fields.availability_status_c.name}-input"
name="{$fields.availability_status_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.availability_status_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.availability_status_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.availability_status_c.name}-input', '{$fields.availability_status_c.name}');sync_{$fields.availability_status_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.availability_status_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.availability_status_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.availability_status_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.availability_status_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.availability_status_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.availability_status_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.availability_status_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.availability_status_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.availability_status_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_AMEYOSESSIONID' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.ameyosessionid_c.value) <= 0}
{assign var="value" value=$fields.ameyosessionid_c.default_value }
{else}
{assign var="value" value=$fields.ameyosessionid_c.value }
{/if}  
<input type='text' name='{$fields.ameyosessionid_c.name}' 
id='{$fields.ameyosessionid_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='_label' width='12.5%' scope="col">
&nbsp;
...
{capture name="label" assign="label"}{sugar_translate label='LBL_AMEYO_CAMPAIGN_ID' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.ameyo_campaign_id_c.value) <= 0}
{assign var="value" value=$fields.ameyo_campaign_id_c.default_value }
{else}
{assign var="value" value=$fields.ameyo_campaign_id_c.value }
{/if}  
<input type='text' name='{$fields.ameyo_campaign_id_c.name}' 
id='{$fields.ameyo_campaign_id_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='_label' width='12.5%' scope="col">
&nbsp;
...
{sugar_translate label='LBL_EDITVIEW_PANEL1' module='Users'}
<script>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ASTERISK_EXT' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.asterisk_ext_c.value) <= 0}
{assign var="value" value=$fields.asterisk_ext_c.default_value }
{else}
{assign var="value" value=$fields.asterisk_ext_c.value }
{/if}  
<input type='text' name='{$fields.asterisk_ext_c.name}' 
id='{$fields.asterisk_ext_c.name}' size='30' 
maxlength='45' 
value='{$value}' title=''      >
<td valign="top" id='asterisk_inbound_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_ASTERISK_INBOUND' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strval($fields.asterisk_inbound_c.value) == "1" || strval($fields.asterisk_inbound_c.value) == "yes" || strval($fields.asterisk_inbound_c.value) == "on"} 
{assign var="checked" value="CHECKED"}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.asterisk_inbound_c.name}" value="0"> 
<input type="checkbox" id="{$fields.asterisk_inbound_c.name}" 
name="{$fields.asterisk_inbound_c.name}" 
value="1" title='' tabindex="0" {$checked} >
</tr>
{/capture}
{if $fieldsUsed > 0 }
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ASTERISK_OUTBOUND' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strval($fields.asterisk_outbound_c.value) == "1" || strval($fields.asterisk_outbound_c.value) == "yes" || strval($fields.asterisk_outbound_c.value) == "on"} 
{assign var="checked" value="CHECKED"}
{else}
{assign var="checked" value=""}
{/if}
<input type="hidden" name="{$fields.asterisk_outbound_c.name}" value="0"> 
<input type="checkbox" id="{$fields.asterisk_outbound_c.name}" 
name="{$fields.asterisk_outbound_c.name}" 
value="1" title='' tabindex="0" {$checked} >
<td valign="top" id='agent_id_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_AGENT_ID' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.agent_id_c.value) <= 0}
{assign var="value" value=$fields.agent_id_c.default_value }
{else}
{assign var="value" value=$fields.agent_id_c.value }
{/if}  
<input type='text' name='{$fields.agent_id_c.name}' 
id='{$fields.agent_id_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_AGENT_NAME' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.agent_name_c.value) <= 0}
{assign var="value" value=$fields.agent_name_c.default_value }
{else}
{assign var="value" value=$fields.agent_name_c.value }
{/if}  
<input type='text' name='{$fields.agent_name_c.name}' 
id='{$fields.agent_name_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
<td valign="top" id='agent_pin_c_label' width='12.5%' scope="col">
{capture name="label" assign="label"}{sugar_translate label='LBL_AGENT_PIN' module='Users'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if strlen($fields.agent_pin_c.value) <= 0}
{assign var="value" value=$fields.agent_pin_c.default_value }
{else}
{assign var="value" value=$fields.agent_pin_c.value }
{/if}  
<input type='text' name='{$fields.agent_pin_c.name}' 
id='{$fields.agent_pin_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
addToValidate('EditView', 'asterisk_inbound_c', 'bool', false,'{/literal}{sugar_translate label='LBL_ASTERISK_INBOUND' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'agent_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AGENT_NAME' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'agent_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AGENT_ID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'download_link_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_DOWNLOAD_LINK' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'download_source_code_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_DOWNLOAD_SOURCE_CODE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'asterisk_outbound_c', 'bool', false,'{/literal}{sugar_translate label='LBL_ASTERISK_OUTBOUND' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'gateway_assigned_c', 'bool', false,'{/literal}{sugar_translate label='LBL_GATEWAY_ASSIGNED' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'agent_pin_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AGENT_PIN' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'asterisk_ext_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ASTERISK_EXT' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'login_flag_c', 'bool', false,'{/literal}{sugar_translate label='LBL_LOGIN_FLAG' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'ameyo_campaign_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AMEYO_CAMPAIGN_ID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'ameyosessionid_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_AMEYOSESSIONID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'availability_status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_AVAILABILITY_STATUS_C' module='Users' for_js=true}{literal}' );
