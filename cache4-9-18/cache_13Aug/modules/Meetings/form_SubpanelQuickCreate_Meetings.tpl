...
{capture name="label" assign="label"}{sugar_translate label='LBL_DISPOSITION' module='Meetings'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
addToValidate('form_SubpanelQuickCreate_Meetings', 'disposition_c', 'enum', false,'{/literal}{sugar_translate label='LBL_DISPOSITION' module='Meetings' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Meetings', 'product_interest_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PRODUCT_INTEREST' module='Meetings' for_js=true}{literal}' );
