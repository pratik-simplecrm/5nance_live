...
',
  ...
  'LBL_NO_PHP_CLI' => 'If your host does not have the PHP binary available, you can use wget or curl to launch your Jobs.<br>for wget: <b>*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;wget --quiet --non-verbose http://13.127.100.216/crm/cron.php > /dev/null 2>&1</b><br>for curl: <b>*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;curl --silent http://13.127.100.216/crm/cron.php > /dev/null 2>&1',
  ...
  'LBL_CONTACT_CREATION' => 'Contact Creation',
  'LBL_ACTIVE_USERS' => 'Active Users',
  'LBL_GETSTATE' => 'Get State Dropdown',
  'LBL_GETCITY' => 'Get City Dropdown',
  'LBL_GETPINCODE' => 'Get Pincode Dropdown',
  'LBL_REASSIGNMENTDATA' => 'ReassignmentData',
  'LBL_USERPRODUCTIVITY' => 'UserProductivity',
  'LBL_CASEAGEING' => 'Case Ageing',
  'LBL_SETUPTIMER_ESCALATION' => 'Setup timer escalation',
  'LBL_LOGINAUDIT' => 'Login Audit',
  'LBL_GOALS_UPDATION' => 'Goals Updation',
  'LBL_SIP_DETAILS' => 'SIP Details',
  'LBL_ADOPTION_PERCENTAGE' => 'Adoption Percentage',
  'LBL_ECSMANDATE_DETAILS' => 'EcsMandate Details',
  'LBL_GETORDERDETAILS' => 'Order Details',
  'LBL_GETNOMINEEDETAILS' => 'Nominee Details',
  'LBL_GETCALLBACKDETAILSFORCRM' => 'CallBack Request',
  'LBL_GETINVESTORBANKACCOUNTFORCRM' => 'Investor Bank Account',
  'LBL_GETLEADSFORCRM' => 'Get Loans',
  'LBL_GETBUDGETFORCRM' => 'Get Budget For CRM',
  'LBL_GETTAXSUMMARYFORCRM' => 'Get Tax Summary For CRM',
  'LBL_GETPAYMENTFAILEDFORCRM' => 'Get Payment Failed For CRM',
  'LBL_GETEQUITYHOLDINGFORCRM' => 'Get Equity Holding For CRM',
  'LBL_GETCARTABANDONMENTDETAILS' => 'Get Cart Abandonment Details',
