<?php /* Smarty version 2.6.11, created on 2018-08-07 11:29:18
         compiled from cache/include/InlineEditing/ContactsEditViewpayment_type_c.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'cache/include/InlineEditing/ContactsEditViewpayment_type_c.tpl', 2, false),array('function', 'html_options', 'cache/include/InlineEditing/ContactsEditViewpayment_type_c.tpl', 10, false),array('function', 'sugar_getimagepath', 'cache/include/InlineEditing/ContactsEditViewpayment_type_c.tpl', 43, false),array('modifier', 'lookup', 'cache/include/InlineEditing/ContactsEditViewpayment_type_c.tpl', 38, false),array('modifier', 'count', 'cache/include/InlineEditing/ContactsEditViewpayment_type_c.tpl', 143, false),)), $this); ?>
...
"
    ...
    <?php if (isset ( $this->_tpl_vars['fields']['payment_type_c']['value'] ) && $this->_tpl_vars['fields']['payment_type_c']['value'] != ''): ?>
        <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['payment_type_c']['options'],'selected' => $this->_tpl_vars['fields']['payment_type_c']['value']), $this);?>

    <?php else: ?>
        <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['payment_type_c']['options'],'selected' => $this->_tpl_vars['fields']['payment_type_c']['default']), $this);?>
