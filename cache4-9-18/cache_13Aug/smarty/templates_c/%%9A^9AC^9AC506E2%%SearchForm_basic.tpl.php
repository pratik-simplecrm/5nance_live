<?php /* Smarty version 2.6.11, created on 2018-08-07 09:42:43
         compiled from cache/modules/Contacts/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Contacts/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/Contacts/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/Contacts/SearchForm_basic.tpl', 44, false),array('function', 'sugar_getimagepath', 'cache/modules/Contacts/SearchForm_basic.tpl', 160, false),array('modifier', 'count', 'cache/modules/Contacts/SearchForm_basic.tpl', 147, false),)), $this); ?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='phone_mobile_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_MOBILE_PHONE','module' => 'Contacts'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['phone_mobile_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['phone_mobile_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['phone_mobile_basic']['value']);  endif; ?>  

<input type='text' name='<?php echo $this->_tpl_vars['fields']['phone_mobile_basic']['name']; ?>
' id='<?php echo $this->_tpl_vars['fields']['phone_mobile_basic']['name']; ?>
...
">
    ...
    <?php endif; ?>
        <button tabindex="2" onclick="SUGAR.savedViews.setChooser();" class="btn btn-outline-primary" type="submit" name="button" id="search_form_submit"/><span class="fa fa-search" style="color:#FFF"></span><?php echo $this->_tpl_vars['APP']['LBL_SEARCH_BUTTON_TITLE']; ?>
</button>&nbsp;
	    <button tabindex='2' title='' onclick='SUGAR.searchForm.clear_form(this.form); return false;' class='btn btn-outline-primary' type='button' name='clear' id='search_form_clear' value='<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_LABEL']; ?>
'/><span class="fa fa-times" style="color:#FFF"></span><?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
</button>
