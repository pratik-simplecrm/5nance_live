...
<td valign="top" id='gateway_assigned_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_GATEWAY_ASSIGNED','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strval ( $this->_tpl_vars['fields']['gateway_assigned_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['gateway_assigned_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['gateway_assigned_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'CHECKED');  else:  $this->assign('checked', "");  endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['gateway_assigned_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['gateway_assigned_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['gateway_assigned_c']['name']; ?>
" 
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='availability_status_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_AVAILABILITY_STATUS_C','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<select name="<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['availability_status_c']['value'] ) && $this->_tpl_vars['fields']['availability_status_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['availability_status_c']['options'],'selected' => $this->_tpl_vars['fields']['availability_status_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['availability_status_c']['options'],'selected' => $this->_tpl_vars['fields']['availability_status_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['availability_status_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['availability_status_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['availability_status_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['availability_status_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['availability_status_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['availability_status_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['availability_status_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['availability_status_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['availability_status_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='ameyosessionid_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_AMEYOSESSIONID','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['ameyosessionid_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ameyosessionid_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ameyosessionid_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ameyosessionid_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['ameyosessionid_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='ameyo_campaign_id_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_AMEYO_CAMPAIGN_ID','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['ameyo_campaign_id_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ameyo_campaign_id_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ameyo_campaign_id_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ameyo_campaign_id_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['ameyo_campaign_id_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDITVIEW_PANEL1','module' => 'Users'), $this);?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='asterisk_ext_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_EXT','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['asterisk_ext_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['asterisk_ext_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['asterisk_ext_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['asterisk_ext_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['asterisk_ext_c']['name']; ?>
' size='30' 
maxlength='45' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
<td valign="top" id='asterisk_inbound_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_INBOUND','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strval ( $this->_tpl_vars['fields']['asterisk_inbound_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['asterisk_inbound_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['asterisk_inbound_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'CHECKED');  else:  $this->assign('checked', "");  endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['asterisk_inbound_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['asterisk_inbound_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['asterisk_inbound_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
</tr>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='asterisk_outbound_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_OUTBOUND','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strval ( $this->_tpl_vars['fields']['asterisk_outbound_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['asterisk_outbound_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['asterisk_outbound_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'CHECKED');  else:  $this->assign('checked', "");  endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['asterisk_outbound_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['asterisk_outbound_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['asterisk_outbound_c']['name']; ?>
" 
value="1" title='' tabindex="0" <?php echo $this->_tpl_vars['checked']; ?>
 >
<td valign="top" id='agent_id_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_AGENT_ID','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['agent_id_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['agent_id_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['agent_id_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['agent_id_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['agent_id_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='agent_name_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_AGENT_NAME','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['agent_name_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['agent_name_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['agent_name_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['agent_name_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['agent_name_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
<td valign="top" id='agent_pin_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_AGENT_PIN','module' => 'Users'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['agent_pin_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['agent_pin_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['agent_pin_c']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['agent_pin_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['agent_pin_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
addToValidate(\'EditView\', \'asterisk_inbound_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_INBOUND','module' => 'Users','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'download_link_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DOWNLOAD_LINK','module' => 'Users','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'asterisk_outbound_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_OUTBOUND','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'gateway_assigned_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_GATEWAY_ASSIGNED','module' => 'Users','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'asterisk_ext_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_EXT','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'login_flag_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LOGIN_FLAG','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'ameyo_campaign_id_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AMEYO_CAMPAIGN_ID','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'ameyosessionid_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AMEYOSESSIONID','module' => 'Users','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'availability_status_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AVAILABILITY_STATUS_C','module' => 'Users','for_js' => true), $this); echo '\' );
