<?php /* Smarty version 2.6.11, created on 2018-08-07 11:10:29
         compiled from cache/modules/Employees/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/modules/Employees/EditView.tpl', 38, false),array('modifier', 'strip_semicolon', 'cache/modules/Employees/EditView.tpl', 63, false),array('modifier', 'lookup', 'cache/modules/Employees/EditView.tpl', 298, false),array('modifier', 'count', 'cache/modules/Employees/EditView.tpl', 378, false),array('function', 'sugar_include', 'cache/modules/Employees/EditView.tpl', 44, false),array('function', 'sugar_translate', 'cache/modules/Employees/EditView.tpl', 51, false),array('function', 'counter', 'cache/modules/Employees/EditView.tpl', 56, false),array('function', 'html_options', 'cache/modules/Employees/EditView.tpl', 273, false),array('function', 'sugar_getimagepath', 'cache/modules/Employees/EditView.tpl', 301, false),array('function', 'sugar_getscript', 'cache/modules/Employees/EditView.tpl', 682, false),)), $this); ?>
...
<ul class="yui-nav">
<li class="selected"><a id="tab0" href="javascript:void(0)"><em><?php echo smarty_function_sugar_translate(array('label' => 'DEFAULT','module' => 'Employees'), $this);?>
</em></a></li>
</ul>
...
, "single", true);'><img src="themes/default/images/id-ff-select.png?v=igGzALk_bn-xeyTYyoHxog"     alt="Select" /></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['reports_to_name']['name']; ?>
...
"><img src="themes/default/images/id-ff-clear.png?v=igGzALk_bn-xeyTYyoHxog"     alt="Clear" /></button></span><?php else:  echo $this->_tpl_vars['fields']['reports_to_name']['value']; ?>
<input accesskey=""  tabindex="0"  type="hidden" name="<?php echo $this->_tpl_vars['fields']['reports_to_id']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['reports_to_id']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['reports_to_id']['value']; ?>
"><?php endif; ?>
...
addToValidate(\'EditView\', \'photo\', \'image\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PHOTO','module' => 'Employees','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'securitygroup_noninher_fields\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_USER_NAME','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'securitygroup_noninherit_id\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_securitygroup_noninherit_id','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'securitygroup_noninheritable\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SECURITYGROUP_NONINHERITABLE','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'securitygroup_primary_group\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_GROUP','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'asterisk_inbound_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_INBOUND','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'agent_name_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AGENT_NAME','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'agent_id_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AGENT_ID','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'download_link_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DOWNLOAD_LINK','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'download_source_code_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DOWNLOAD_SOURCE_CODE','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'asterisk_outbound_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_OUTBOUND','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'gateway_assigned_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_GATEWAY_ASSIGNED','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'agent_pin_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AGENT_PIN','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'asterisk_ext_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_EXT','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'login_flag_c\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LOGIN_FLAG','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'ameyo_campaign_id_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AMEYO_CAMPAIGN_ID','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'ameyosessionid_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AMEYOSESSIONID','module' => 'Employees','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'availability_status_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_AVAILABILITY_STATUS_C','module' => 'Employees','for_js' => true), $this); echo '\' );
