...
<script>var disabledModules={"Accounts":"Accounts","Bugs":"Bugs","Opportunities":"Opportunities","Project":"Project","ProjectTask":"ProjectTask","Prospects":"Prospects","Tasks":"Tasks"};</script>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='reminders_label' width='12.5%' scope="col">
...
unset($_smarty_tpl_vars);
 ?>
<td valign="top" id='asterisk_caller_id_c_label' width='12.5%' scope="col">
...
<input type='text' name='<?php echo $this->_tpl_vars['fields']['asterisk_caller_id_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['asterisk_caller_id_c']['name']; ?>
' size='30' 
maxlength='45' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title='trimmed callerId'      >
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0):  echo $this->_tpl_vars['tableRow']; ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='scrm_products_activities_1_calls_name_label' width='12.5%' scope="col">
&nbsp;
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
addToValidate(\'EditView\', \'reminders\', \'function\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REMINDER','module' => 'Calls','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'reschedule_history\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RESCHEDULE_HISTORY','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'reschedule_count\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RESCHEDULE_COUNT','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'asterisk_caller_id_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_CALLER_ID','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'customerid_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CUSTOMERID','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'setuptime_c\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SETUPTIME','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'campaignid_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGNID','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'dispositioncode_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DISPOSITIONCODE','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'ivrtime_c\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_IVRTIME','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'dstphone_c\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DSTPHONE','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'crtobjectid_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CRTOBJECTID','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'start_date_c\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_START_DATE','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'dispositionclass_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DISPOSITIONCLASS','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'ringingtime_c\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RINGINGTIME','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'recordingfileurl_c\', \'url\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RECORDINGFILEURL','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'srcphone_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SRCPHONE','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'calltype_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CALLTYPE','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'callid_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CALLID','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'systemdisposition_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SYSTEMDISPOSITION','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'phone_c\', \'phone\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PHONE','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'talktime_c\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TALKTIME','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'non_office_menu_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NON_OFFICE_MENU','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'language_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LANGUAGE','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'product_interest_c\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PRODUCT_INTEREST','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'linkclicked_date_c\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LINKCLICKED_DATE','module' => 'Calls','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'registration_date_c\', \'date\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REGISTRATION_DATE','module' => 'Calls','for_js' => true), $this); echo '\' );
