...
//For Adding background image Auto populating template id in hidden input changes by Roshan Sarode 9-5-18 start
      
        var mytest = $('#email_template' + idx).val();
        $('#get_template' + idx).val(mytest);
     //For Adding background image Auto populating template id in hidden input changes by Roshan Sarode 9-5-18 end   
        //bug #20680
    ...
    sendEmail : function(idx, isDraft) {
        ...
        var get_template = document.getElementById('get_template' + idx).value;         //Background Image changes for email template by roshan sarode 9-5-18
        ...
        form.get_template.value=get_template;                            //Background Image changes for email template by roshan sarode 9-5-18
        // email attachments
